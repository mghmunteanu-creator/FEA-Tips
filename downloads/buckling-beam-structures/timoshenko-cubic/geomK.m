...
for ie=1:nel
    ...
    ge2=(ga*L^2 + 12*ei)^2;
    kelg=[ 0,                               0,                              0, 0,                               0,                              0
           0,  L*(1/L^2 + (L^2*ga^2)/(5*ge2)),            (L^4*ga^2)/(10*ge2), 0, -L*(1/L^2 + (L^2*ga^2)/(5*ge2)),            (L^4*ga^2)/(10*ge2)
           0,             (L^4*ga^2)/(10*ge2), L*((L^4*ga^2)/(20*ge2) + 1/12), 0,            -(L^4*ga^2)/(10*ge2), L*((L^4*ga^2)/(20*ge2) - 1/12)
           0,                               0,                              0, 0,                               0,                              0
           0, -L*(1/L^2 + (L^2*ga^2)/(5*ge2)),           -(L^4*ga^2)/(10*ge2), 0,  L*(1/L^2 + (L^2*ga^2)/(5*ge2)),           -(L^4*ga^2)/(10*ge2)
           0,             (L^4*ga^2)/(10*ge2), L*((L^4*ga^2)/(20*ge2) - 1/12), 0,            -(L^4*ga^2)/(10*ge2), L*((L^4*ga^2)/(20*ge2) + 1/12)];
    kelg=-N(ie)*kelg;
